 ...
 *  runs traccc seeding, and prints seed count. Stops before track_params_estimation
 *  so it works without a valid detray detector geometry for the TML format.
 */
...
int main(int argc, char* argv[]) {
    ...
    for (std::size_t ev = 0; ev < n_events; ++ev) {
        ...
        traccc::edm::measurement_collection<traccc::default_algebra>::host meas{host_mr};

        traccc::io::read_spacepoints(sp, meas, ev, data_dir,
                                     nullptr, nullptr,
